                    ...
                    return (
                        <button
                            ...
                            style={{
                                ...
                                outline: 'none', cursor: 'pointer', padding: '4px 6px', margin: 0,
                                color: isActive ? '#137fec' : '#94a3b8', transition: 'color 0.2s', flex: 1,
                            }}
                        >
              <span
                  className="material-symbols-outlined"
                  style={{ fontSize: '22px', ...(isActive ? { fontVariationSettings: "'FILL' 1" } : {}) }}
              >
                {tab.icon}
              </span>
                            <span style={{ fontSize: '8px', fontWeight: 600, letterSpacing: '0.4px', lineHeight: 1.2, textAlign: 'center' }}>
                {tab.label}
              </span>
                        </button>
                    )
